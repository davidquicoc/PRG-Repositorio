                        ...
                        <form method="post" action="crearSesion.jsp">
                            ...
                            <div>
                                ...
                                <select id="ID_peliculaSe" name="ID_pelicula" required>
                                    <%
                                        ResultSet rsPSelect = stmt.executeQuery("SELECT ID_pelicula, titulo FROM pelicula WHERE ID_pelicula = 1");
                            ...
                            <div>
                                ...
                                <select id="ID_salaSe" name="ID_sala" required>
                                    <%
                                        String sqlSa = "SELECT ID_sala, nombre FROM sala WHERE ID_sala = 1";
                            ...
                            <div>
                                ...
                                <input type="text" size="4" id="Fecha_Hora" name="Fecha_Hora" required>
                            </div>
                            <div>
