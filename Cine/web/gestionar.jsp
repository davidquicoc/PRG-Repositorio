                ...
                <section class="salas">
                    ...
                    <div class="bloque-crear-sala">
                        <form method="post" action="#">
                            ...
                            <div>
                                <p>P. Minusválido</p>
                                <p><input type="radio" id="p1" name="personasConMovilidadReducida" value="true" checked>&nbsp;<label for="p1">Si</label></p>
                                <p><input type="radio" id="p2" name="personasConMovilidadReducida" value="false" checked>&nbsp;<label for="p2">No</label></p> 
                            </div>
                            <div>
                                <p>Estado</p>
