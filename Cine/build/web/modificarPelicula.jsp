...
<html>
    ...
    <body>
        ...
        <form method="post" action="actualizarPelicula.jsp">
            ...
            <input type="radio" id="est1" name="estado_pelicula" value="true" <%= request.getParameter("estado_pelicula").equals("true") ? "checked" : ""%>>

            <br>
            <label for="est2">Baja</label>
            <input type="radio" id="est2" name="estado_pelicula" value="false" <%= !request.getParameter("estado_pelicula").equals("false") ? "checked" : ""%>>
